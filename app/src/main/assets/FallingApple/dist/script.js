...
function dropBox(){
  ...
  if(thisBox.data("test")){
    thisBox.css({"background": "url('file:///android_res/mipmap/freshapple.png')", "background-size":"contain"});
  } else {
    thisBox.css({"background": "url('file:///android_res/mipmap/rottenapple.png')", "background-size":"contain"});
  }
